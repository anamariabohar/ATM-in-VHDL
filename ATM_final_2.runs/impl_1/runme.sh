...
HD_PWD='C:/Users/Bohar Anamaria/Desktop/ATM_final_2/ATM_final_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bancomat.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bancomat.tcl -notrace
