...
HD_PWD='C:/Users/Bohar Anamaria/Desktop/ATM_final_2/ATM_final_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bancomat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bancomat.tcl
