...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {cont[1]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {cont[0]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {Pin[3]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {Pin[2]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {Pin[1]}]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {Pin[0]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {wer}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {eroare}]

set_property PACKAGE_PIN U3 [get_ports {OP4}]
set_property IOSTANDARD LVCMOS33 [get_ports {OP4}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {corect}]
